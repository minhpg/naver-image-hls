...
module.exports = async (fileid) => {
    try {
        if(fileid.includes('img.png')){
            proxy_url = `https://story-img.kakaocdn.net/dn${fileid}`
        }
        if(fileid.includes('PNG')){
            proxy_url = `http://post-phinf.pstatic.net${fileid}`
        }
        else{
            proxy_url = fileid
        }
        const response = await fetch("https://docs.google.com/picker/v2/geturl?origin=https%3A%2F%2Fdocs.google.com&authuser=0", {
            ...
            "body": `[\"ureq\",[null,[[1,6,14],[\"image/bmp\",\"image/gif\",\"image/jpeg\",\"image/png\",\"image/tiff\",\"application/vnd.google-apps.folder\",\"application/vnd.google-apps.photoalbum\"],[],[]],[2],null,9007199254740991,[],null,\"https://docs.google.com/picker/v2/\",\"Chọn một tệp\",\"vi\",null,null,null,null,null,null,null,[5],null,[\"https://jamboard.google.com\",\":0\",2,2,[null,null],[null,null],[null,null]],null,null,28,\"jam-insert-image\",null,null,\"https://jamboard.google.com\",[],null,null,null,null,null,null,null],\"${proxy_url}\",0,0]`,
            "method": "POST",
            "mode": "cors"
        })
